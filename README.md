...
> Honestly, this is such a hassle, PyInstaller has a tonne of problems, especially with QThread's & Whisper, hence my workaround in the .spec file. Better to just run the transient.py file..
